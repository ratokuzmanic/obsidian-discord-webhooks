...
⚡ **Send preset messages via Obsidian commands** with one command per message (works great with the [Buttons plugin](https://github.com/shabegom/buttons)).

## 📦 Installation

1. Copy `main.js`, `styles.css`, and `manifest.json` from the [latest release](https://github.com/ratokuzmanic/obsidian-discord-webhooks/releases/latest) into:  
